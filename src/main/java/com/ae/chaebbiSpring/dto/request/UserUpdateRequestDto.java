...
public class UserUpdateRequestDto {
    @Schema(name = "age", description = "사용자 수정 나이", nullable = false, example = "26", type = "String")
    private String age;
    ...
    @Schema(name = "activity", description = "사용자 수정 활동점수", nullable = false, example = "40", type = "String")
